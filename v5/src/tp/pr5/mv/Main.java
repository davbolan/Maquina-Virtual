...
import tp.pr5.mv.executionMode.*;
 ...
 * - La entrada podra ser por teclado, por fichero (el cu�l se especifica) o nula(-1). </br>
...
public class Main {
	...
	/**
	 * Lee un programa a partir de un archivo
	 */
	private static ProgramMV readProgramFromFile() {
		...
		catch (IncorrectProgramException epe) {
			ProgramLoader.closeFile();
